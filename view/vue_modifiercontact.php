...
<head>
  ...
  <title>Modifier Contact Form</title>
...
<body>
  <section class="wrapper_form">
    <div class="form signup">
      <header>Modifier contact</header>
      <form action="../controller/logique_modifier.php" method="post">
        ...
        <input type="submit" value="Modifier Coordonnées" name="modifier_contact" />
      </form>
    </div>
