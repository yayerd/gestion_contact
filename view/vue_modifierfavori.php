...
<body>
  <section class="wrapper_form">
    <div class="form signup">
      <header>Modifier le statut favori</header>
      <form action="../controller/logique_favorite.php" method="post">
        ...
        <input type="text" name="prenom"  value="<?php echo $c_contact->getPrenom(); ?>"  readonly required /> 
        <input type="text" name="nom" value="<?php echo $c_contact->getNom(); ?>" readonly required />
        <input type="number" name="telephone" value="<?php echo $c_contact->getTelephone(); ?>" readonly required />
        <div class="checkbox">
          <Label class="info_title" name="is_favorite">Est-ce un contact favori ?</Label>
          <select name="is_favorite" class="modifier_favori">
            <option value="oui" <?php if ($c_contact->getFavori() == 'oui') echo 'selected' ; ?>>Oui</option>
            <option value="non" <?php if ($c_contact->getFavori() == 'non') echo 'selected' ; ?>>Non</option>
          </select>
        </div>
